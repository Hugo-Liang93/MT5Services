...
用法：
    python tools/walkforward_runner.py --tf H1 --splits 5
    python tools/walkforward_runner.py --tf M30 --start 2025-09-01 --end 2026-03-30 --splits 6
    python tools/walkforward_runner.py --tf H1 --train-ratio 0.75 --metric sharpe_ratio
