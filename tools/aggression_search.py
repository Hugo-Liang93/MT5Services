...
用法：
    python tools/aggression_search.py --tf H1
    python tools/aggression_search.py --tf M30,H1
    python tools/aggression_search.py --tf H1 --strategies structured_trend_continuation
    python tools/aggression_search.py --tf H1 --step 0.05
