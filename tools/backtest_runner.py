...
用法：
    ...
    python tools/backtest_runner.py --tf H1,M30,M15,M5 --start 2025-12-30 --end 2026-03-30
    python tools/backtest_runner.py --tf M15 --template regime_detail
    python tools/backtest_runner.py --tf H1 --monte-carlo
    python tools/backtest_runner.py --tf H1,M30,M15 --compare
