...
用法：
    python tools/sltp_grid_search.py --tf H1
    python tools/sltp_grid_search.py --tf H1 --sl-range 1.5,2.0,2.5,3.0,3.5 --tp-range 2.0,3.0,4.0,5.0
    python tools/sltp_grid_search.py --tf M30 --top 10
