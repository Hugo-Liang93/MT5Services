...
用法：
    python tools/correlation_runner.py --tf H1
    python tools/correlation_runner.py --tf M30 --threshold 0.70
    python tools/correlation_runner.py --tf H1,M30 --start 2025-12-30 --end 2026-03-30
