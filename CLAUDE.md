...
- **14 个策略实例**（12 个结构化策略类，trend_continuation 衍生 2 个 H4 变体，其中 2 个冻结：session_breakout / lowbar_entry）| **16 个 Studio Agent**
...
| 结构化策略（12 类） | `src/signals/strategies/structured/` |
