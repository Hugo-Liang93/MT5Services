...
def build_executor_config(signal_config: "SignalConfig") -> ExecutorConfig:
    return ExecutorConfig(
        ...
        cross_tf_switch_min_confidence=signal_config.cross_tf_switch_min_confidence,
        cross_tf_switch_min_age_hours=signal_config.cross_tf_switch_min_age_hours,
        cross_tf_switch_max_r=signal_config.cross_tf_switch_max_r,
